...
- **Codes:** new gaps use this repo's prefix `G-ANALYTICS-`. Take the "Next code" below, then bump it in the same edit. Codes are never reused or renamed.
